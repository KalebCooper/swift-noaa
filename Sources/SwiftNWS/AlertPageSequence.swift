...
/// A lazy sequence of alert-history pages in service order.
///
...
/// for try await page in client.alertPages(matching: query) {
///   print(page.features.count)
///   break
/// }
/// ```
public struct AlertPageSequence: AsyncSequence, Sendable {
